...
/**
 * @minions-oss-projects/cli — CLI for Minions Oss-projects
 *
...
import { customTypes } from '@minions-oss-projects/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Oss-projects'));
        console.log(chalk.dim('Project definitions, repos, version history, and health status'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-oss-projects/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-oss-projects/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-oss-projects')}`);
