# Manual Setup Steps for Minions Oss-projects
...
Go to **GitHub → mxn2020/minions-oss-projects → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-oss-projects` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-oss-projects-web`
- **GitHub repo**: `mxn2020/minions-oss-projects`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `oss-projects.minions.wtf`

### Documentation
- **Netlify site name**: `minions-oss-projects-docs`
- **GitHub repo**: `mxn2020/minions-oss-projects`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `oss-projects.minions.help`

### Blog
- **Netlify site name**: `minions-oss-projects-blog`
- **GitHub repo**: `mxn2020/minions-oss-projects`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `oss-projects.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `oss-projects.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `oss-projects.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `oss-projects.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-oss-projects/sdk`](https://www.npmjs.com/package/@minions-oss-projects/sdk)
- CLI: [`@minions-oss-projects/cli`](https://www.npmjs.com/package/@minions-oss-projects/cli)
...
Your package: [`minions-oss-projects`](https://pypi.org/project/minions-oss-projects/)
...
| Item | Value |
|------|-------|
| Project | `minions-oss-projects` |
| SDK (npm) | `@minions-oss-projects/sdk` |
| CLI (npm) | `@minions-oss-projects/cli` |
| Python (PyPI) | `minions-oss-projects` |
| GitHub | `github.com/mxn2020/minions-oss-projects` |
| Docs domain | `oss-projects.minions.help` |
| Blog domain | `oss-projects.minions.blog` |
| App domain | `oss-projects.minions.wtf` |
